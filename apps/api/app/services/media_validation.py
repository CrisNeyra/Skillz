...
def validate_media_confirm(user: User, payload: MediaConfirm) -> None:
    ...
    if cloudinary_configured() and settings.cloudinary_cloud_name:
        ...
        # Some Cloudinary delivery hosts include the cloud name as subdomain.
    ...
    if "res.cloudinary.com" in host:
        # Expect path like /<cloud_name>/image|video/upload/...
        ...
        # public_id should appear in the delivery URL path
